<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequiredDocEdit.aspx.cs" Inherits="DefenseTraining.Web.RequiredDocEdit" %>
    ...
    <script type="text/javascript">
        ...
        function saveData() {
            ...
            $.ajax({
                ...
                data: '{"requiredDoc":' + JSON.stringify(_requiredDoc) + '}',
